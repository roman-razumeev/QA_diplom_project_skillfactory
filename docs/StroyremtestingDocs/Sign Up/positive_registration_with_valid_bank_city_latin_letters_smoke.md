...
Регистрация нового пользователя (юридическое лицо) с вводом латинских букв в поле "Город банка" (данные о счете организации)
...
4. Все поля заполнены валидными данными, кроме поля "Город банка" (данные о счете организации)
* Шаги:
1. В поле "Город банка" (данные о счете организации) ввести название города, состоящее из латинских букв
