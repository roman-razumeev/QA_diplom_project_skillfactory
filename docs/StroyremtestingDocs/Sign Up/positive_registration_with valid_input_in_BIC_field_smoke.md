...
Регистрация нового пользователя (юридическое лицо) с введенны валидным номером БИК
...
4. Все поля заполнены валидными данными, кроме поля "БИК" (данные о счете организации)
* Шаги:
1. В поле "БИК" (данные о счете организации) ввести числа 04 и еще 7 чисел от 0 до 9 и нажать кнопку "Зарегистрироваться"
