...
- Шаги:
  ...
  1.Выбрать товар с черным ценником от 15000 и выше, запомнить цену. 
...
- Ожидаемый результат:
  ...
  1.Сумма за товар в корзине и в блоке "Итого" равны и отображаются с учетом суммарной скидки (1,5%+5%) от цены в каталоге.
  
  2.В поле "Скидка" указана суммарная скидка по клубной карте и за объем покупки (1,5%+5%) от цены товара в каталоге.
...
| ---------- | ----- | --------- | ----- | ----------------------------- |
| 2023-08-09 | 18:11 | FAIL      | Ирина | https://trello.com/c/5BEWhx8o |
